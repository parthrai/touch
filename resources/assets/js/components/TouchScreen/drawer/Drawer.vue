<template>
    <transition name="router-anim" enter-active-class="animated bounceIn" leave-active-class="animated fadeOutDown">
                ...
                <div class="row">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="tile"> <a href="#/Map"><nav-tiles :img="'map.png'" :caption="'Map'"></nav-tiles></a></td>
