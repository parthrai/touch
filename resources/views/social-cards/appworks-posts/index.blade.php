          ...
          <div class="panel-body">
            <div class="row">
              ...
              <div
                ...
                "
              >
                <a href="{{ route( 'tweets.dashboard' ) }}" class="btn btn-primary pull-right">Go to Tweets Dashboard</a>
              </div>
            </div>
            <div class="row">
              <div
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <div>
                            @if( $card->GetApproved() )
                              <a
                                href="/appworks-posts/reject/{{ $card->id }}"
                                class="btn btn-danger"
                              >Reject</a>
                            @else
                              <a
                                href="/appworks-posts/approve/{{ $card->id }}"
                          ...
                          <div>
                            @if( $card->GetFeatured() )
                              <a
                                href="/appworks-posts/unfeature/{{ $card->id }}"
                                class="btn btn-danger"
                              >Unfeature</a>
                            @else
                              <a
                                href="/appworks-posts/feature/{{ $card->id }}"
