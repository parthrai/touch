          ...
          <div class="panel-body">
            ...
            <div class="row">
              ...
              <div
                ...
                "
              >
                <a href="{{ route( 'appworks-posts.dashboard' ) }}" class="btn btn-primary pull-right">Go to AppWorks Posts Dashboard</a>
              </div>
            </div>
                        ...
                        <td class="text-center">
                          <ul class="list-unstyled list-inline">
                            <li>
                              @if( $card->GetApproved() )
                                <a
                                  href="/tweets/reject/{{ $card->id }}"
                                  class="btn btn-danger"
                                >Reject</a>
                              @else
                                <a
                                  href="/tweets/approve/{{ $card->id }}"
                            ...
                            <li>
                              @if( $card->GetFeatured() )
                                <a
                                  href="/tweets/unfeature/{{ $card->id }}"
                                  class="btn btn-danger"
                                >Unfeature</a>
                              @else
                                <a
                                  href="/tweets/feature/{{ $card->id }}"
