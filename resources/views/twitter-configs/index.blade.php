                  ...
                  <tbody>
                    @foreach( $configs as $config )
                      <tr>
                        ...
                        <td>
                          @if( $config->enabled )
                            <a class="btn btn-danger" href="{{ route( 'twitter-hashtags.disable', $config->id ) }}">Disable</a>
                          @else
                            <a class="btn btn-success" href="{{ route( 'twitter-hashtags.enable', $config->id ) }}">Enable</a>
                          @endif
                        </td>
                        ...
                        <td>
                          <modal-confirm-href-action
                            ...
                            action-href="/twitter-hashtags/delete/{{ $config->id }}"
